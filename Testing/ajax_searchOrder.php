...
{
  global $pdf_link,$SITE_URL, $pdf_link1;
 	 ...
 	 if($status!='')
 {
  ...
  {    
    $query2 .=" and  W.ward_category ='$customer'";  
  	...
  	if($_REQUEST['type']!='')
  {    
    $query2 .=" and  WC.type ='$customertype'";  
  } 
  ...
  {  
      ...
      $id               =   $row['id'];
       ...
       if($loop%2==0)
		  ...
		  $pdf_link1="<a href=\"$SITE_URL/epdf/quotePDF1.php?id=$id\"><img src=\"$SITE_URL/images/icon_pdf.png\" align='top' style=\"height:20px\"></a>";
    ...
    $SEARCH_LIST.="<tr id=\"cus_$id\" $class>
                      ...
                      <td>$ward_name</td>
                       ...
                       <td>$date_filled</td>
                      <td>$status</td>                    
                     <td><a href=\"$SITE_URL/edit_order.php?id=$id\"><img src=\"$SITE_URL/images/icon_search.png\" align='top' align='top' style=\"height:20px\"></a>&nbsp;<input type=\"image\" src=\"$SITE_URL/images/icon_close.png\" style='vertical-align:top;height:20px;' height='20' />&nbsp;$pdf_link1</td>   
                    </tr>";	
