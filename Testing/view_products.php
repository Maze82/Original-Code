...
function getData($db,$db1)
{
 ...
 $page=$_REQUEST['page'];
  ...
  $customer1=trim($_REQUEST['customer']);
   ...
   $query1="select distinct(P.id), P.product_name,P.product_weight,P.description,P.code,WP.ward_id from products as P left join ward_products as WP on WP.product_id=P.id left join wards as W on W.id=WP.ward_id where 1=1 ";
		
		
	   $query2="select distinct(P.id), P.product_name,P.product_weight,P.description,P.code,WP.ward_id from products as P left join ward_products as WP on WP.product_id=P.id left join wards as W on W.id=WP.ward_id where 1=1";
