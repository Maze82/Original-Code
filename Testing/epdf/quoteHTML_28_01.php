  ...
  $sql=mysql_query("SELECT ward_name,ward_category FROM wards WHERE id=$ward_id");
    ...
    { 
     ...
     $dispatched_quantity   = $row1['dispatched_quantity'];
        ...
        $ProdList.="<tr>
        	<td style=\"padding:6px 5px 6px 10px; border-right:1px solid #000; border-bottom:1px solid #000;font-size:14px;\">$product_title</td>
        	<td style=\"border-right:1px solid #000; text-align:center; border-bottom:1px solid #000;font-size:14px;\">$product_limit</td>
        	<td style=\"border-bottom:1px solid #000; text-align:center;font-size:14px;\">$dispatched_quantity</td>
        </tr>";          
      }
	 }  
     $ProdList.=""; 
   ...
   // $html_file  = "pdf3/event_pdf_".mktime().".html";
    ...
    fclose($fp);
	 ...
	 //  $new_file_name =  "pdf3/ReportHTML".".html";
      //echo $new_file_name; exit;
      
      //$mpdf=new mPDF('utf-8','A4'); 
 /*     $mpdf = new mPDF('utf-8',    // mode - default ''
 'A6',    // format - A4, for example, default ''
