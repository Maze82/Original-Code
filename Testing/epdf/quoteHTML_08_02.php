  ...
  $sql=mysql_query("SELECT ward_name,ward_category FROM wards WHERE id=$ward_id");
    ...
    { 
     ...
     $dispatched_quantity   = $row1['dispatched_quantity'];
        ...
        $ProdList.="<tr>
        	<td style=\"padding:2px; border-right:1px solid #000; border-bottom:1px solid #000;font-size:12px;\">$product_title</td>
        	<td style=\"border-right:1px solid #000; text-align:center; border-bottom:1px solid #000;font-size:12px;\">$product_limit</td>
        	<td style=\"border-bottom:1px solid #000; text-align:center;font-size:12px;\">$dispatched_quantity</td>
        </tr>";          
      }
	 }  
     $ProdList.=""; 
