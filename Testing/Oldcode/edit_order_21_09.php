...
{
        global $id,$ordered_date,$date_filled,$ward_id,$ordering_person,$email,$total_weight,$item_ordered,$status_unfill,$status_fill,$products,$status,$WARD_LIST,$current_date,$item_order,$delivery_date,$counter,$total_weight;
			...
			while($row=$db->fetch_assoc()){
				...
				$products .="<tr>
                               ...
                               <td align=\"right\"><input type=\"text\" name=\"p_qty$product_id-$i\" id=\"p_qty_$i\" style=\"width:40px\" class=\"input_txt\" value=\"$product_quantity\" onchange=\"return getquantity($product_id,'p_qty_$i');\" /></td>
								<td align=\"right\"><input type=\"text\" name=\"d_qty$product_id-$i\" id=\"d_qty\" style=\"width:40px\" class=\"input_txt\" value=\"$dispatched_quantity\"  /></td>
