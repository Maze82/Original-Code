...
if($_GET['ord_id']!='')
{
     ...
     $db->query($delete2);
	 header("Location:view_orders_demo.php");
     exit; 
}
...
display_message(); 
 ...
 $PAGE_CONTENTS	  = ReadTemplate("$TEMPLATE_DIR/view_order_demo.html");
  ...
  $db->query($query1);
	...
	if($PAGE_NAVS == '') $PAGE_NAVS = '';
	 ...
	 if($customer1!=''||$costcentre1!=''||$orderdate1!=''||$orderdate2!=''||$filleddate1!=''||$filleddate2!=''||$status1!=''||$products1!=''||$customertype1!='')
      ...
      $pdf_link="PDF-Report<a href=\"$SITE_URL/epdf/quotePDF_demo.php?customer=$customer1&costcentre=$costcentre1&order_date1=$orderdate1&order_date2=$orderdate2&filleddate1=$filleddate1&filleddate2=$filleddate2&status=$status1&product=$products1&type=$customertype1\"><img src=\"$SITE_URL/images/icon_pdf.png\" align='top' align='top'></a>";
	  }
	  else
	  {
	 // $pdf_link='';
