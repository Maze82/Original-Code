		...
		{$total_filled_weight=$rec1['filled_weight'];
		  ...
		  $PAGE_LIST.="<tr id=\"ep_$id\">
                      ...
                      <td>$item_ordered</td>                      
					   ...
					   <td>$date_filled</td> 
					    <td>$status</td>                     
                       <td><a href=\"$SITE_URL/edit_order.php?id=$id\"><img src=\"$SITE_URL/images/icon_search.png\" align='top' style=\"height:20px\"></a>&nbsp;<input type=\"image\" src=\"$SITE_URL/images/icon_close.png\" style='vertical-align:top;height:20px;' onclick=\"remove_order($id);\" />&nbsp;<a href=\"$SITE_URL/epdf/quotePDF1.php?id=$id\"><img src=\"$SITE_URL/images/icon_pdf.png\" align='top' style=\"height:20px\"></a>&nbsp;<a href=\"$SITE_URL/epdf/quoteHTML.php?id=$id\"><img src=\"$SITE_URL/images/printer.png\" align='top' style=\"height:20px\"></a></td>                      
                    </tr>";	
