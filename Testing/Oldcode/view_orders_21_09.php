...
function getData($db,$db1)
{
  ...
  global $SITE_URL,$PAGE_LIST,$MEMBER_ID,$pdf_link;
	 ...
	 if($customer1!=''||$costcentre1!=''||$orderdate1!=''||$orderdate2!=''||$filleddate1!=''||$filleddate2!=''||$status1!=''||$products1!=''||$customertype1!='')
	  {
	   ...
	   // echo "hi";exit;
      $pdf_link="PDF-Report<a href=\"$SITE_URL/epdf/quotePDF.php?customer=$customer1&costcentre=$costcentre1&order_date1=$orderdate1&order_date2=$orderdate2&filleddate1=$filleddate1&filleddate2=$filleddate2&status=$status1&product=$products1\"><img src=\"$SITE_URL/images/icon_pdf.png\" align='top' align='top'></a>";
	  }
	  else
	  {
	  $pdf_link='';
        ...
        $total_filled_weight=$rec1['filled_weight'];
		  ...
		  $PAGE_LIST.="<tr id=\"ep_$id\">
                      ...
                      <td>$item_ordered</td>                      
					   ...
					   <td>$date_filled</td> 
					    <td>$status</td>                     
                       <td><a href=\"$SITE_URL/edit_order.php?id=$id\"><img src=\"$SITE_URL/images/icon_search.png\" align='top' style=\"height:20px\"></a>&nbsp;<input type=\"image\" src=\"$SITE_URL/images/icon_close.png\" style='vertical-align:top;height:20px;' onclick=\"remove_order($id);\" />&nbsp;<a href=\"$SITE_URL/epdf/quotePDF1.php?id=$id\"><img src=\"$SITE_URL/images/icon_pdf.png\" align='top' style=\"height:20px\"></a><!--&nbsp;<img src=\"$SITE_URL/images/printer.png\" align='top' style=\"height:20px\" onclick=\"printing_page($id);\">--></td>                      
                    </tr>";	
