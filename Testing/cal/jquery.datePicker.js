			...
			return this.each(
				function()
				{
					...
					if (!alreadyExists && s.createButton) {
						// create it!  <img src="http://getsifty.brainwork.com/images/cal.gif" alt="Pick a date">
						controller.button = $('<a href="#" class="add-strips"><img style="border:0px;" src="/images/calander-icon.gif" alt="Pick" align="absmiddle" /></a>')
