...
if($HOST_NAME == "fm.bwi.com")
{
       // $DOCUMENT_ROOT                  = "/var/www/vhosts/reel-comic/httpdocs";
        ...
        $DB_USERNAME                    = "laundryk_testing";             // Database Username
        $DB_PASSWORD                    = '!IeyK*{0TDud';                 // Password for the Db User
        $DB_NAME                        = "laundryk_Testing";
		...
		$MAP_VROOT_PATH                 = "";
		$SITE_URL_PAYEMNT = "http://fm.bwi.com";	
}else{
       ...
       $DB_USERNAME                    = "laundryk_testing";                     // Database Username
        $DB_PASSWORD                    = '!IeyK*{0TDud';                 // Password for the Db User
        $DB_NAME                        = "laundryk_Testing";                       // Database name
        $DB_REPORT_ERROR                = false;                        // To Report Error
        $DB_PERSISTENT_CONN             = false;                        // If Db Connection to be persistent
		//Application directory Path of the app from Virtual root
		$MAP_VROOT_PATH                 = "";
...
$SITE_URL_CLIENT                = "http://$HOST_NAME$MAP_VROOT_PATH/client";
//HTML Global Templates Location
$TEMPLATE_DIR                   = "$DOCUMENT_ROOT$MAP_VROOT_PATH/templates";
$TEMPLATE_DIR_CLIENT            = "$DOCUMENT_ROOT$MAP_VROOT_PATH/templates/client";
...
$DIR_UPLOAD_PRODUCT_FILE         = "$DOCUMENT_ROOT$MAP_VROOT_PATH/uploadedFiles/product";
...
$DIR_DISPLAY_USER_FILE      = "$MAP_VROOT_PATH/uploadedFiles/user";
$DIR_UPLOAD_USER_FILE        = "$DOCUMENT_ROOT$MAP_VROOT_PATH/uploadedFiles/user";
